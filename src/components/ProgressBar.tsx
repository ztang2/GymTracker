...
const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  // Use gradientColors if provided, otherwise use barColor
  const finalColor = gradientColors || barColor;
